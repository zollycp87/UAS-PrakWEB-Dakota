...
<head>
    <meta charset="utf-8">
    <title>Data Film Dakota Cinema</title>
    ...
    <div class="container-fluid position-relative d-flex p-0">
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                <a href="data_film.php" class="navbar-brand d-flex d-lg-none me-4">
                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h5 class="mb-4 d-flex justify-content-between">Data Film Sedang Tayang
                                <a href="kelola_film.php">
                                <button type="submit" class="btn btn-outline-primary btn-sm">Tambah Data Film<i class="fas fa-plus m-2"></i>
                                </a>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <?php 
                                    include "koneksi.php";
                                        $query_mysql = mysqli_query($conn,"SELECT * FROM film")or die(mysqli_error($conn));
                                        $nomor = 1;
